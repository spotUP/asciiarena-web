  ...
  <?php
    if ($type == "ASCII") 
    {
      ...
      <div class="row ml-0 mr-0 amb-1 p-0 xs-m-0 xs-m-0 xs-p-0 s-m-0 justify-content-center align-items-center" style="overflow-y: scroll; height: 100vh; background-color: <?=$bgcolor?>;">
        <div class="row ml-0 mr-0 amb-1 p-0 xs-m-0 xs-m-0 xs-p-0 s-m-0 justify-content-center align-items-center" style="background-color: <?=$bgcolor?>; width: 640px;" id="colly-div"><pre id="colly" style="overflow: hidden;font-family: <?=$font;?>; color: <?=$fgcolor?>; white-space: pre;"><?php
