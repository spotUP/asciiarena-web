          ...
          <ul className="navbar-nav">
            <li className="nav-item dropdown">
              ...
              <div className="dropdown-menu ascii" aria-labelledby="collys-dropdown">
                ...
                <Link className="dropdown-item ascii" href="/collys?sort_by=filename">By Filename</Link>
                <Link className="dropdown-item ascii" href="/collys?sort_by=artists">By Artist</Link>
                <Link className="dropdown-item ascii" href="/collys?sort_by=crews">By Crew</Link>
                <Link className="dropdown-item ascii" href="/collys?sort_by=cdate&sort_order=D">By Release Date</Link>
                <Link className="dropdown-item ascii" href="/collys?sort_by=timestamp&sort_order=D">By Upload Date</Link>
                <Link className="dropdown-item ascii" href="/collys?sort_by=uploader">By Uploader</Link>
              </div>
            </li>
            ...
            <li className="nav-item dropdown">
              ...
              <div className="dropdown-menu ascii" aria-labelledby="mags-dropdown">
                ...
                <Link className="dropdown-item ascii" href="/mags?sort_by=filename">By Filename</Link>
                <Link className="dropdown-item ascii" href="/mags?sort_by=author">By Author</Link>
              </div>
            </li>
            ...
            <li className="nav-item dropdown">
              ...
              <div className="dropdown-menu ascii" aria-labelledby="apps-dropdown">
                ...
                <Link className="dropdown-item ascii" href="/apps?sort_by=filename">By Filename</Link>
                <Link className="dropdown-item ascii" href="/apps?sort_by=author">By Author</Link>
              </div>
            </li>

            <li className="nav-item"><Link className="nav-link ascii apr-1" href="/artists">ARTiSTS</Link></li>
            ...
            <li className="nav-item dropdown">
              ...
              <div className="dropdown-menu ascii" aria-labelledby="submit-dropdown">
                ...
                <Link className="dropdown-item ascii" href="/submit#crew">Crew</Link>
                <Link className="dropdown-item ascii" href="/submit#artist">Artist</Link>
                <Link className="dropdown-item ascii" href="/submit#bbs">BBS</Link>
                <Link className="dropdown-item ascii" href="/submit#app">ASCII App</Link>
                <Link className="dropdown-item ascii" href="/submit#ascii_mag">ASCII Mag</Link>
                <Link className="dropdown-item ascii" href="/submit#request">Request</Link>
                <Link className="dropdown-item ascii" href="/submit#sitelogo">aSCIIaRENA Logo</Link>
              </div>
            </li>
