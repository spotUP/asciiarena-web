...
export default function BBSWeektop() {
  ...
  useEffect(() => {
    const containerId = `bbsweektop_${uid}`;

    function fetchBBSWeektop() {
      fetch(
        "https://scenewall.bbs.io:1543/GlobalLastCallers/api/GlobalLastCallers/Stats?StatType=26&Count=5"
      )
        .then((r) => r.json())
