				...
				<ul class="navbar-nav">
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu ascii" aria-labelledby="themes">
							...
							<a class="dropdown-item ascii" href="/collys.php?sort_by=date&sort_order=DESC">By Release Date<span style="font-size: 16px; font-family:Monaco, monospace;">&nbsp;</span></a>
