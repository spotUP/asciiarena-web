...
<body>
	...
	<div class="noise"></div>
	<div class="navbar navbar-expand-lg fixed-top navbar-dark bg-white d-flex justify-content-between" style="height: 22px; margin-bottom: 2px; padding-right: 2px;">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav">
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" style="padding-right: 8px;" data-toggle="dropdown" href="/collys.php?sort_by=releasedate"
						id="themes">COLLYS<span class="caret" style="padding-right: 8px;"></span></a>
						<div class="dropdown-menu" aria-labelledby="themes">
							<a class="dropdown-item" href="/collys.php?sort_by=name">By Name<span style="padding-left: 7px; font-size: 16px; font-family:Monaco, monospace;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></a>
							<a class="dropdown-item" href="/collys.php?sort_by=filename">By Filename<span style="padding-left: 4px; font-size: 16px; font-family:Monaco, monospace;">&nbsp;&nbsp;&nbsp;&nbsp;</span></a>
							<a class="dropdown-item" href="/collys.php?sort_by=nick">By Artist<span style="padding-left: 10px; font-size: 16px; font-family:Monaco, monospace;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></a>
							<a class="dropdown-item" href="/collys.php?sort_by=releasedate">By Release Date<span style="font-size: 16px; font-family:Monaco, monospace;">&nbsp;</span></a>
							<a class="dropdown-item" href="/collys.php?sort_by=timestamp">By Upload Date<span style="padding-left: 8px; font-size: 16px; font-family:Monaco, monospace;">&nbsp;</span></a>
							<a class="dropdown-item" href="/collys.php?sort_by=uploader">By Uploader<span style="padding-left: 13px; font-size: 16px; font-family:Monaco, monospace;">&nbsp;&nbsp;&nbsp;</span></a>
						</div>
					</li>
					<li class="nav-item">
					...
					if (!is_logged_in()) {
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="account">
								...
								?>
								<div class="dropdown-divider">~~~~~~~~</div>
								<a class="dropdown-item" href="/cmds.php?cmd=logout">LOGOUT<span style="padding-left: 7px; font-size: 16px; font-family:Monaco, monospace;">&nbsp;</span></a>
							</div>
						</li>
						<?php
					}
					?>
					<li class="nav-item">
						<a class="nav-link" style="padding-right: 8px;" target="popup" onclick="window.open('/up-rough-amp/index.html','name','width=275,height=450')">MUSIC PLAYER</a>
					</li>
				</ul>
			</div>
		</div>
