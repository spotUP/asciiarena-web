								...
								if(is_admin()) 
								{
									...
									<li class="nav-item dropdown">
										...
										<div class="dropdown-menu dropdown-menu-fix bg-red ascii" aria-labelledby="themes">
											...
											<a class="dropdown-item ascii" href="/admin.php#ascii_mag">Edit Mag<span style="padding-left: 13px;">   </span></a>
				...
				<div class="row" style="padding-top: 58px; padding-bottom: 16px;">
					<div class="col-12 d-flex align-items-center justify-content-center m-0 p-0 m-md-0 p-md-0 m-sm-1 p-sm-1">
						...
						<div class="overflow-hidden d-none d-lg-block mx-auto">
							<div id="logoswitcher">
								<div class="logo nolink overflow-hidden"><?=implode('</div><div pre class="logo nolink" style="display: none; white-space: pre;">', $logos)?></pre>
							</div>
						</div>
