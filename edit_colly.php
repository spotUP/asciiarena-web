...
<div class="tab-pane fade show active ap-1" id="colly">
  ...
  <?php } ?>
		...
		<div class="row apb-1"><div class="col-6 d-flex justify-content-between">
			...
			<input type="button" value="Add Author!" onclick="addCollyArtist()"/>
		</div>
	</div>
	...
	<div class="row apb-1">
		<div class="col-6 d-flex justify-content-between">
			...
			<input type="button" value="Add Crew!" onclick="addCollyCrew()"/>
		</div>
	</div>
	<div class="row">
		<div class="col-12">
