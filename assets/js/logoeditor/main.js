...
TAAG.getText = function(txt, txtId, font, fontName) {
    ...
    return "<pre " + idStr + " style='float:left; overflow: hidden; width: 640px; height: 512px' class='"+TAAG.displayClass(font.getFontType(),fontName)+"' contenteditable='true'>" + txt + "</pre><div style=\"clear:both\"></div>";
};
...
TAAG.displayTestAll = function() {
    ...
    var output = document.getElementById("outputFigDisplay");
    var testAllHtml = "<div id='taagTestAll' style=\"width:640px; height: 512px;\"><pre style=\"text-align:center;\" class=\"fig\">" + TAAG.testAll.banner + "</pre>";
