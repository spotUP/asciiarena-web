...
<div class="container fluid col-12 p-0 pl-lg-2 pr-lg-2">
	<div class="header col-lg-12 p-0">
		<h2 class="ap-1 bg-header text-truncate lightgreen"><a class="lightgreen" href="/apps.php/">LATEST ADDED APPS</a> <a class="lightgreen" href="/rss.php?class=0">[RSS]</a></h2>
	</div>
