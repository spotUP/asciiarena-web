...
foreach($collys as $fname => $colly) 
{
	...
	<div class="col-12 d-flex justify-content-center col-<?=$breakpoint?><?=(round(12 / $columns))?> overflow-hidden apt-1 apb-1">
		<div class="row animate__animated animate__backInUp">
			...
			<pre style="opacity: 0.1; position: absolute; top: 8px; left: 4px;"><a href="/release/<?=$fname?>" class="ascii magenta"><?=$colly?></a></pre>
			<pre style="opacity: 0.06; position: absolute; top: 16px left: 8px;"><a href="/release/<?=$fname?>" class="ascii magenta"><?=$colly?></a></pre>
			<pre style="opacity: 0.03; position: absolute; top: 24px; left: 12px;"><a href="/release/<?=$fname?>" class="ascii magenta"><?=$colly?></a></pre>
