...
<div class="mx-auto navbar navbar-expand-lg fixed-bottom navbar-dark bg-primary d-flex justify-content-between" style="height: 22px;">
	<span cass="red">NComm 2.0</span>
	<span class="green">aSCIIaRENA</span>
	<span class="green"><?php echo Date("H:i", time()), " 00:00"; ?></span>
</div>
